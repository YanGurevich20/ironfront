...
static var tank_controller_scenes: Dictionary[TankControllerType, PackedScene] = {
	...
	preload("res://controllers/mobile_player_tank_controller/mobile_player_tank_controller.tscn"),
	TankControllerType.AI: preload("res://controllers/ai_tank_controller/ai_tank_controller.tscn"),
	TankControllerType.DUMMY:
	preload("res://controllers/dudmmy_tank_controller/dummy_tank_controller.tscn"),
}
