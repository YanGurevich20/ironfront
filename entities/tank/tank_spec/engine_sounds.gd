...
const SMALL_ENGINE_SOUNDS: Dictionary[SPEED_TYPE, AudioStream] = {
	SPEED_TYPE.SLOW:
	preload("res://entities/tank/shared_assets/sounds/engine/small/engine_small_slow.ogg"),
	SPEED_TYPE.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/engine/small/engine_small_normal.ogg"),
	SPEED_TYPE.FAST:
	preload("res://entities/tank/shared_assets/sounds/engine/small/engine_small_fast.ogg")
}
const MEDIUM_ENGINE_SOUNDS: Dictionary[SPEED_TYPE, AudioStream] = {
	SPEED_TYPE.SLOW:
	preload("res://entities/tank/shared_assets/sounds/engine/medium/engine_medium_slow.ogg"),
	SPEED_TYPE.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/engine/medium/engine_medium_normal.ogg"),
	SPEED_TYPE.FAST:
	preload("res://entities/tank/shared_assets/sounds/engine/medium/engine_medium_fast.ogg")
}
const LARGE_ENGINE_SOUNDS: Dictionary[SPEED_TYPE, AudioStream] = {
	SPEED_TYPE.SLOW:
	preload("res://entities/tank/shared_assets/sounds/engine/large/engine_large_slow.ogg"),
	SPEED_TYPE.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/engine/large/engine_large_normal.ogg"),
	SPEED_TYPE.FAST:
	preload("res://entities/tank/shared_assets/sounds/engine/large/engine_large_fast.ogg")
}
