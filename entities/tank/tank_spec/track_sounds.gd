...
const SMALL_TRACK_SOUNDS: Dictionary[Enums.SpeedType, AudioStream] = {
	...
	preload("res://entities/tank/shared_assets/sounds/track_rattle/small/track_small_slow.ogg"),
	Enums.SpeedType.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/small/track_small_normal.ogg"),
	Enums.SpeedType.FAST:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/small/track_small_fast.ogg")
}

const MEDIUM_TRACK_SOUNDS: Dictionary[Enums.SpeedType, AudioStream] = {
	Enums.SpeedType.SLOW:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/medium/track_medium_slow.ogg"),
	Enums.SpeedType.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/medium/track_medium_normal.ogg"),
	Enums.SpeedType.FAST:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/medium/track_medium_fast.ogg")
}

const LARGE_TRACK_SOUNDS: Dictionary[Enums.SpeedType, AudioStream] = {
	Enums.SpeedType.SLOW:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/large/track_large_slow.ogg"),
	Enums.SpeedType.NORMAL:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/large/track_large_normal.ogg"),
	Enums.SpeedType.FAST:
	preload("res://entities/tank/shared_assets/sounds/track_rattle/large/track_large_fast.ogg")
}
