...
func _add_docks() -> void:
	...
	_dock = (
		preload("res://addons/GodotPlayGameServices/godot_play_game_services_dock.tscn")
		. instantiate()
	)
...
func _add_autoloads() -> void:
	add_autoload_singleton(
		PLUGIN_AUTOLOAD,
		"res://addons/GodotPlayGameServices/scripts/autoloads/godot_play_game_services.gd"
	)
