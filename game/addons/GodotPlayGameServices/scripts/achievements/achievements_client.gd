...
func _connect_signals() -> void:
	if GodotPlayGameServices.android_plugin:
		GodotPlayGameServices.android_plugin.achievementUnlocked.connect(
			func(is_unlocked: bool, achievement_id: String):
				achievement_unlocked.emit(is_unlocked, achievement_id)
		)
		GodotPlayGameServices.android_plugin.achievementsLoaded.connect(
			func(achievements_json: String):
		...
		GodotPlayGameServices.android_plugin.achievementRevealed.connect(
			func(is_revealed: bool, achievement_id: String):
