...
enum ScoreOrder { SCORE_ORDER_LARGER_IS_BETTER = 1, SCORE_ORDER_SMALLER_IS_BETTER = 0 }  ## Scores are sorted in descending order.  ## Scores are sorted in ascending order.
