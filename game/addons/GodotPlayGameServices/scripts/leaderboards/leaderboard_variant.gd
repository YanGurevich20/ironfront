...
enum TimeSpan { TIME_SPAN_DAILY = 0, TIME_SPAN_WEEKLY = 1, TIME_SPAN_ALL_TIME = 2 }  ## A leaderboard that resets everyday.  ## A leaderboard that resets every week.  ## A leaderboard that never resets.

## Collection type for leaderboards.
enum Collection { COLLECTION_PUBLIC = 0, COLLECTION_FRIENDS = 3 }  ## A public leaderboard.  ## A leaderboard only with friends.
