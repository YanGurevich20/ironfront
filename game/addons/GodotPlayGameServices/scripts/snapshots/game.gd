...
func _init(dictionary: Dictionary) -> void:
	if dictionary.has("areSnapshotsEnabled"):
		are_snapshots_enabled = dictionary.areSnapshotsEnabled
	if dictionary.has("achievementTotalCount"):
		achievement_total_count = dictionary.achievementTotalCount
	if dictionary.has("applicationId"):
		application_id = dictionary.applicationId
	if dictionary.has("description"):
		description = dictionary.description
	if dictionary.has("developerName"):
		developer_name = dictionary.developerName
	if dictionary.has("displayName"):
		display_name = dictionary.displayName
	if dictionary.has("leaderboardCount"):
		leaderboard_count = dictionary.leaderboardCount
	if dictionary.has("primaryCategory"):
		primary_category = dictionary.primaryCategory
	if dictionary.has("secondaryCategory"):
		secondary_category = dictionary.secondaryCategory
	if dictionary.has("themeColor"):
		theme_color = dictionary.themeColor
	if dictionary.has("hasGamepadSupport"):
		has_gamepad_support = dictionary.hasGamepadSupport
	...
	if dictionary.has("featuredImageUri"):
		featured_image_uri = dictionary.featuredImageUri
