...
func _ready() -> void:
	if GodotPlayGameServices.android_plugin:
		...
		GodotPlayGameServices.android_plugin.gameLoaded.connect(
		...
		GodotPlayGameServices.android_plugin.conflictEmitted.connect(
			func(json_data: String):
				var safe_dictionary := GodotPlayGameServices.json_marshaller.safe_parse_dictionary(
					json_data
				)
		...
		GodotPlayGameServices.android_plugin.snapshotsLoaded.connect(
			func(json_data: String):
...
func show_saved_games(
	title: String, allow_add_button: bool, allow_delete: bool, max_snapshots: int
) -> void:
	if GodotPlayGameServices.android_plugin:
		GodotPlayGameServices.android_plugin.showSavedGames(
			title, allow_add_button, allow_delete, max_snapshots
		)
...
func save_game(
	...
	if GodotPlayGameServices.android_plugin:
		GodotPlayGameServices.android_plugin.saveGame(
			file_name, description, save_data, played_time_millis, progress_value
		)
