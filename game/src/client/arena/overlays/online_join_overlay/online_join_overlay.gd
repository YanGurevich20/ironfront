...
func _ready() -> void:
	...
	Utils.connect_checked(
		retry_button.pressed, func() -> void: MultiplayerBus.online_join_retry_requested.emit()
	)
	Utils.connect_checked(
		cancel_button.pressed, func() -> void: MultiplayerBus.online_join_cancel_requested.emit()
	)
	Utils.connect_checked(close_button.pressed, func() -> void: close_requested.emit())
	begin()
